...
const Projects = () => {
  ...
  return (
    <section id="projects" className="py-20 px-1 md:px-6">
  ...
  {/* Projects Grid */}
  <div className={`transition-all duration-500 ${selectedProject ? 'lg:w-1/2 w-full' : 'w-full'}`}>
    <div className={`grid gap-6 transition-all duration-500 grid-cols-1 ${selectedProject ? 'lg:grid-cols-1' : 'lg:grid-cols-2'}`}>
      {projects.map((project, index) => (
        <div key={index}>
          ...
          {/* GitHub Repository Browser - appears below card on mobile only */}
  ...
  {/* GitHub Repository Browser for Desktop - side by side */}
  {selectedProject && (
